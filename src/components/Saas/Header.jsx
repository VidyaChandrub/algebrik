      ...
      <div className="container section-head style-5 py-lg-0 py-4 ">
        <div className="row gap-5 gap-lg-0">
          <div className="col-lg-6 col-md-6 col-12 col-sm-12 ">
            <h1 className=""><span className='text_blue'>Digital loan origination starts here</span></h1>
            <h3 className="heading_sec mt-lg-3 my-2">Take prospects from<br></br>
                <span className="fw-bold fst-italic">Looked to Booked in minutes,</span><br></br>
                not days</h3>
            <a className='btn blue5-3Dbutn hover-blue2 btn-sm  text-white mt-lg-3 mt-2 ' href="https://forms.gle/BGmp1RrHHoo2QAQv6" target="_blank" >Read for demo</a>
          </div>
